        ...
        return (
            <div className='InputPanelContainer scriptArgsTab'>
                ...
                <div className='spacing'>
                    ...
                    />
                    &nbsp;
                    <span class="tooltip" data-tooltip="Length of phrase extracted from each sentence."><i aria-hidden="true" className="question circle fitted icon"></i></span>
                </div>
                ...
                <div className='spacing'>
                    ...
                    &nbsp;
                    <span class="tooltip" data-tooltip="Method used for generating phrase vectors."><i aria-hidden="true" className="question circle fitted icon"></i></span>
                </div>
                ...
                <div className='spacing'>
                    ...
                    <Dropdown placeholder='Select set of background corpus docs'
                        ...
                        onChange={this.getDropdownValue} />
                    &nbsp;
                    <span class="tooltip" data-tooltip="Set(s) of documents used to generate the TF-IDF."><i aria-hidden="true" className="question circle fitted icon"></i></span>
                </div>
                ...
                <div className='spacing'>
                    ...
                    />
                    &nbsp;
                    <span class="tooltip" data-tooltip="Only relevant for UMAP and SVD clustering. Dimensions to which the tfidf matrix is reduced."><i aria-hidden="true" className="question circle fitted icon"></i></span>
                </div>

                <div className='spacing'>
                    <Checkbox id='include_sentiment' label="Include sentiment?" title="" defaultChecked />
                    &nbsp;
                    <span class="tooltip" data-tooltip="Checking this box means that part of speech and sentiment will be used to weight the importance of tokens."><i aria-hidden="true" className="question circle fitted icon"></i></span>
                </div>
                ...
                <div className='spacing'>
                    ...
                    &nbsp;
                    <span class="tooltip" data-tooltip="Method used to cluster word vectors."><i aria-hidden="true" className="question circle fitted icon"></i></span>
                </div>
                ...
                <div className='spacing'>
                    ...
                    <Dropdown placeholder='Select distance metric'
                        ...
                        onChange={this.getDropdownValue} />
                        &nbsp;
                        <span class="tooltip" data-tooltip="This distance metric is used to compare points for clustering."><i aria-hidden="true" className="question circle fitted icon"></i></span>
                </div>
                ...
                <div className='spacing'>
                    ...
                    />
                    &nbsp;
                    <span class="tooltip" data-tooltip="Corresponds to the cut height of the dendrogram for HAC clustering and K for k-means clustering."><i aria-hidden="true" className="question circle fitted icon"></i></span>
                </div>
                ...
                <div className='spacing'>
                    ...
                    <Dropdown placeholder='Select Visualization Method'
                        ...
                        onChange={this.getDropdownValue} />
                        &nbsp;
                        <span class="tooltip" data-tooltip="Method used for projecting points into two dimensions for visualization."><i aria-hidden="true" className="question circle fitted icon"></i></span>
                </div>
                ...
                <div className='spacing'>
                    ...
                    <Dropdown placeholder='Select distance metric'
                        ...
                        onChange={this.getDropdownValue} />
                        &nbsp;
                        <span class="tooltip" data-tooltip="This distance metric is used to compare points for visualization"><i aria-hidden="true" className="question circle fitted icon"></i></span>
                </div>
                ...
                <div className='spacing'>
                    ...
                    />
                    &nbsp;
                    <span class="tooltip" data-tooltip="Only relevant for UMAP clustering."><i aria-hidden="true" className="question circle fitted icon"></i></span>
                </div>
