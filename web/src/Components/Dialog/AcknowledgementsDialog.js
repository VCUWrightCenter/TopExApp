...
export default function AlertDialog() {
  ...
  return (
    <div>
      <Button id="acknowledgements-button" variant="contained" style={{backgroundColor: '#3f51b5', color: '#FFF'}} onClick={handleClickOpen}>Acknowledgments</Button>
      <Dialog
        open={open}
        onClose={handleClose}
      ...
      >
        ...
        <DialogContent>
            <DialogContentText id="alert-dialog-description">
                ...
                <p>In addition, Evan French and Peter Burdette from VCU’s Wright Center for Clinical and Translational Research Informatics Core have been working tirelessly with Amy Olex to get TopEx ready for public release.  Thanks to both of you for your amazing work!</p>

                <h4>Citation:</h4>

                <p>If you use TopEx in your research, please cite:</p>
